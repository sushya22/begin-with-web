...
<html>
    <head>
      ...
      <link rel="stylesheet" href="donorloginstyle.css">
    </head>
    <body>
        <div class="class1">
            <ul>
            ...
            <div class="class3">
                <div class="container">
                    ...
                    <form action="donorloginback.php" method="post">

                      
                       
                      <div class="class4">
                           <label for="username">Username</label>
                           <input type="text" name="username" Placeholder="Enter The Username" id="username" required>
                      </div>
                    ...
                    <div class="class4">
                        <a href="donorforgotpassword.php" class="class5">forgot password?</a> 
                         <p class="class5">Don't have account?</p> <a href="donorregistration.php" class="class5">Sign-up here</a>
                  </div>
