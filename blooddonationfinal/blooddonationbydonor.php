...
<html>
    <head>
      ...
      <link rel="stylesheet" href="bloodrequestbydonor.css">
    </head>
    <body>
        <div class="class1">
            <ul>
            ...
            <div class="class3">
                <div class="container">
                    ...
                    <form action="blooddonationbydonorback.php" method="post">
                    ...
                    <div class="class4">
                          ...
                          <input type="submit" name="submit" value="Send Request to Donate">
                    </div>
