...
$query1="select requestblood.pid, patient.pname, requestblood.disease, requestblood.bloodtype, requestblood.units from requestblood,patient where requestblood.pid=patient.pid";
...
<html>
    <head>
      ...
      <link rel="stylesheet" href="patientrequestfinal.css">
    </head>
    <body>
        <div class="class1">
            <ul>
                   ...
                   <table class="classtable">
                       ...
                       <?php
                           ...
                           <tr>
                            ...
                            <td>
                            <form action="acceptedpatientinsert.php" method="post">
                            ...
                            <td >
                                ...
                                <input type="hidden" name="pid" value="<?php echo $row1[0];?>">
